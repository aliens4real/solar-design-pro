...
export function seedResidential(es, specs, isComm, ivs) {
  ...
  const markers = [
    ...
    mk("res_mtr", 130, 400, "meter", "Utility Meter", "Revenue", "exterior"),
    mk("res_pm", 130, 450, "prod_meter", "Prod. Meter", "", "exterior"),
    mk("res_gec", 120, 530, "grounding", "GEC", "Ground Rod", "exterior"),
    mk("res_inv", 250, 600, "inverter", invLabel(ivs, 0), invDetail(ivs, 0), "basement"),
    mk("res_acd", 350, 670, "disconnect", "AC Disconnect", "Lockable", "basement"),
    mk("res_pnl", 460, 730, "panel", "Main Panel", `${es}A Service`, "basement"),
    mk("res_sub", 570, 790, "panel", "Sub-Panel", "Basement", "basement"),
  ];
